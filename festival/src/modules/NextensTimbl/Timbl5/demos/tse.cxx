/*
 *    tse.cc Timbl Script Engine
 *
 *    An example of a simple TimblAPI main program
 *    We build an engine which is capable of processing scripts
 *    to train and classify textfiles using various TimblAPI
...
void one_command( istream &in_file, int &line_count ) {
  ...
  case New: {
    ...
    if ( len == 2 )
      ...
      alg = "-a IB1";
    experiments[exp_cnt++] = new TimblAPI( alg, params[0] );
