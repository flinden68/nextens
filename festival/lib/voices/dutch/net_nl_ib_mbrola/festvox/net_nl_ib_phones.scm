;;; $Id: net_nl_ib_phones.scm,v 1.1 2003/11/28 13:43:17 joopk Exp $
;;;
...
;; Not in CGN, present in IB/NL3 database
   (ai  +   l   d   2   1   -   0   0   0) ;; IB/NL3 haai
   (oi  +   l   d   2   1   -   0   0   0) ;; IB/NL3 mooi
   (ui  +   l   d   2   1   -   0   0   0) ;; IB/NL3 boei
   (Ai  +   l   d   2   1   -   0   0   0) ;; IB/NL3 ai
   (Oi  +   l   d   2   1   -   0   0   0) ;; IB/NL3 hoi
   (L   -   0   0   0   0   0   l   a   +) ;; IB/NL3 bal
   ;; other
   (?   0   0   0   0   0   -   0   0   -) ;; IB/NL3 glottal stop
